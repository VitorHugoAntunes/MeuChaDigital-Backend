...
exports.updateGiftSchema = exports.createGiftSchema = void 0;
...
exports.updateGiftSchema = zod_1.z.object({
    ...
    totalValue: zod_1.z.number().positive('O valor total deve ser positivo').optional(),
    categoryId: zod_1.z.string().min(3, 'O ID da categoria está inválido').optional(),
});
